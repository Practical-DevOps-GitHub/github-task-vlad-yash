...
class ScriptTest < Test::Unit::TestCase
  ...
  def test_approve_from_user
    user_name = 'softservedata'
    classic_require_code_owner_review = @obj.rules_required_pull_request_reviews('main')["require_code_owner_reviews"].nil? || @obj.rules_required_pull_request_reviews('main')["require_code_owner_reviews"]
    pull_request_rulesets_rules = @obj.get_branch_ruleset('main')
